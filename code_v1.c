...
//servo groups  ****************************************
#define FIRST_LVL_SERVOS  0b000000000000000000111111
#define SECOND_LVL_SERVOS 0b000000000000111111000000
#define THIRD_LVL_SERVOS  0b000000111111000000000000
#define FORTH_LVL_SERVOS  0b111111000000000000000000

#define FIRST_LVL_FRONT_SERVOS  0b000000000000000000100001
#define FIRST_LVL_MIDDLE_SERVOS 0b000000000000000000010010
#define FIRST_LVL_BACK_SERVOS   0b000000000000000000001100
#define FIRST_LVL_LEFT_SERVOS   0b000000000000000000111000
#define FIRST_LVL_RIGHT_SERVOS  0b000000000000000000000111

#define SECOND_LVL_FRONT_SERVOS  0b000000000000100001000000
#define SECOND_LVL_MIDDLE_SERVOS 0b000000000000010010000000
#define SECOND_LVL_BACK_SERVOS   0b000000000000001100000000
#define SECOND_LVL_LEFT_SERVOS   0b000000000000111000000000
#define SECOND_LVL_RIGHT_SERVOS  0b000000000000000111000000

#define THIRD_LVL_FRONT_SERVOS  0b000000100001000000000000
#define THIRD_LVL_MIDDLE_SERVOS 0b000000010010000000000000
#define THIRD_LVL_BACK_SERVOS   0b000000001100000000000000
#define THIRD_LVL_LEFT_SERVOS   0b000000111000000000000000
#define THIRD_LVL_RIGHT_SERVOS  0b000000000111000000000000

#define FORTH_LVL_FRONT_SERVOS  0b100001000000000000000000
#define FORTH_LVL_MIDDLE_SERVOS 0b010010000000000000000000
#define FORTH_LVL_BACK_SERVOS   0b001100000000000000000000
#define FORTH_LVL_LEFT_SERVOS   0b111000000000000000000000
...
void setup()
{
  ...
  for(char i = 0; i < SERVO_COUNT; i++)
  {
    ...
    pwm1.setPWM(i, 0, servos[i].pos);
    pwm2.setPWM(i, 0, servos[i].pos);
  }
...
void numbered_command()
{
  ...
  {
    //servo controlling
   case CMD_SERVO_1_ON: modify_bitfield(&states, 0, ON); break;
case CMD_SERVO_1_OFF: modify_bitfield(&states, 0, OFF); break;
case CMD_SERVO_1_CC: modify_bitfield(&directions, 0, CC); break;
case CMD_SERVO_1_CW: modify_bitfield(&directions, 0, CW); break;
case CMD_SERVO_2_ON: modify_bitfield(&states, 1, ON); break;
case CMD_SERVO_2_OFF: modify_bitfield(&states, 1, OFF); break;
case CMD_SERVO_2_CC: modify_bitfield(&directions, 1, CC); break;
case CMD_SERVO_2_CW: modify_bitfield(&directions, 1, CW); break;
case CMD_SERVO_3_ON: modify_bitfield(&states, 2, ON); break;
case CMD_SERVO_3_OFF: modify_bitfield(&states, 2, OFF); break;
case CMD_SERVO_3_CC: modify_bitfield(&directions, 2, CC); break;
case CMD_SERVO_3_CW: modify_bitfield(&directions, 2, CW); break;
case CMD_SERVO_4_ON: modify_bitfield(&states, 3, ON); break;
case CMD_SERVO_4_OFF: modify_bitfield(&states, 3, OFF); break;
case CMD_SERVO_4_CC: modify_bitfield(&directions, 3, CC); break;
case CMD_SERVO_4_CW: modify_bitfield(&directions, 3, CW); break;
case CMD_SERVO_5_ON: modify_bitfield(&states, 4, ON); break;
case CMD_SERVO_5_OFF: modify_bitfield(&states, 4, OFF); break;
case CMD_SERVO_5_CC: modify_bitfield(&directions, 4, CC); break;
case CMD_SERVO_5_CW: modify_bitfield(&directions, 4, CW); break;
case CMD_SERVO_6_ON: modify_bitfield(&states, 5, ON); break;
case CMD_SERVO_6_OFF: modify_bitfield(&states, 5, OFF); break;
case CMD_SERVO_6_CC: modify_bitfield(&directions, 5, CC); break;
case CMD_SERVO_6_CW: modify_bitfield(&directions, 5, CW); break;
case CMD_SERVO_7_ON: modify_bitfield(&states, 6, ON); break;
case CMD_SERVO_7_OFF: modify_bitfield(&states, 6, OFF); break;
case CMD_SERVO_7_CC: modify_bitfield(&directions, 6, CC); break;
case CMD_SERVO_7_CW: modify_bitfield(&directions, 6, CW); break;
case CMD_SERVO_8_ON: modify_bitfield(&states, 7, ON); break;
case CMD_SERVO_8_OFF: modify_bitfield(&states, 7, OFF); break;
case CMD_SERVO_8_CC: modify_bitfield(&directions, 7, CC); break;
case CMD_SERVO_8_CW: modify_bitfield(&directions, 7, CW); break;
case CMD_SERVO_9_ON: modify_bitfield(&states, 8, ON); break;
case CMD_SERVO_9_OFF: modify_bitfield(&states, 8, OFF); break;
case CMD_SERVO_9_CC: modify_bitfield(&directions, 8, CC); break;
case CMD_SERVO_9_CW: modify_bitfield(&directions, 8, CW); break;
case CMD_SERVO_10_ON: modify_bitfield(&states, 9, ON); break;
case CMD_SERVO_10_OFF: modify_bitfield(&states, 9, OFF); break;
case CMD_SERVO_10_CC: modify_bitfield(&directions, 9, CC); break;
case CMD_SERVO_10_CW: modify_bitfield(&directions, 9, CW); break;
case CMD_SERVO_11_ON: modify_bitfield(&states, 10, ON); break;
case CMD_SERVO_11_OFF: modify_bitfield(&states, 10, OFF); break;
case CMD_SERVO_11_CC: modify_bitfield(&directions, 10, CC); break;
case CMD_SERVO_11_CW: modify_bitfield(&directions, 10, CW); break;
case CMD_SERVO_12_ON: modify_bitfield(&states, 11, ON); break;
case CMD_SERVO_12_OFF: modify_bitfield(&states, 11, OFF); break;
case CMD_SERVO_12_CC: modify_bitfield(&directions, 11, CC); break;
case CMD_SERVO_12_CW: modify_bitfield(&directions, 11, CW); break;
case CMD_SERVO_13_ON: modify_bitfield(&states, 12, ON); break;
case CMD_SERVO_13_OFF: modify_bitfield(&states, 12, OFF); break;
case CMD_SERVO_13_CC: modify_bitfield(&directions, 12, CC); break;
case CMD_SERVO_13_CW: modify_bitfield(&directions, 12, CW); break;
case CMD_SERVO_14_ON: modify_bitfield(&states, 13, ON); break;
case CMD_SERVO_14_OFF: modify_bitfield(&states, 13, OFF); break;
case CMD_SERVO_14_CC: modify_bitfield(&directions, 13, CC); break;
case CMD_SERVO_14_CW: modify_bitfield(&directions, 13, CW); break;
case CMD_SERVO_15_ON: modify_bitfield(&states, 14, ON); break;
case CMD_SERVO_15_OFF: modify_bitfield(&states, 14, OFF); break;
case CMD_SERVO_15_CC: modify_bitfield(&directions, 14, CC); break;
case CMD_SERVO_15_CW: modify_bitfield(&directions, 14, CW); break;
case CMD_SERVO_16_ON: modify_bitfield(&states, 15, ON); break;
case CMD_SERVO_16_OFF: modify_bitfield(&states, 15, OFF); break;
case CMD_SERVO_16_CC: modify_bitfield(&directions, 15, CC); break;
case CMD_SERVO_16_CW: modify_bitfield(&directions, 15, CW); break;
case CMD_SERVO_17_ON: modify_bitfield(&states, 16, ON); break;
case CMD_SERVO_17_OFF: modify_bitfield(&states, 16, OFF); break;
case CMD_SERVO_17_CC: modify_bitfield(&directions, 16, CC); break;
case CMD_SERVO_17_CW: modify_bitfield(&directions, 16, CW); break;
case CMD_SERVO_18_ON: modify_bitfield(&states, 17, ON); break;
case CMD_SERVO_18_OFF: modify_bitfield(&states, 17, OFF); break;
case CMD_SERVO_18_CC: modify_bitfield(&directions, 17, CC); break;
case CMD_SERVO_18_CW: modify_bitfield(&directions, 17, CW); break;
case CMD_SERVO_19_ON: modify_bitfield(&states, 18, ON); break;
case CMD_SERVO_19_OFF: modify_bitfield(&states, 18, OFF); break;
case CMD_SERVO_19_CC: modify_bitfield(&directions, 18, CC); break;
case CMD_SERVO_19_CW: modify_bitfield(&directions, 18, CW); break;
case CMD_SERVO_20_ON: modify_bitfield(&states, 19, ON); break;
case CMD_SERVO_20_OFF: modify_bitfield(&states, 19, OFF); break;
case CMD_SERVO_20_CC: modify_bitfield(&directions, 19, CC); break;
case CMD_SERVO_20_CW: modify_bitfield(&directions, 19, CW); break;
case CMD_SERVO_21_ON: modify_bitfield(&states, 20, ON); break;
case CMD_SERVO_21_OFF: modify_bitfield(&states, 20, OFF); break;
case CMD_SERVO_21_CC: modify_bitfield(&directions, 20, CC); break;
case CMD_SERVO_21_CW: modify_bitfield(&directions, 20, CW); break;
case CMD_SERVO_22_ON: modify_bitfield(&states, 21, ON); break;
case CMD_SERVO_22_OFF: modify_bitfield(&states, 21, OFF); break;
case CMD_SERVO_22_CC: modify_bitfield(&directions, 21, CC); break;
case CMD_SERVO_22_CW: modify_bitfield(&directions, 21, CW); break;
case CMD_SERVO_23_ON: modify_bitfield(&states, 22, ON); break;
case CMD_SERVO_23_OFF: modify_bitfield(&states, 22, OFF); break;
case CMD_SERVO_23_CC: modify_bitfield(&directions, 22, CC); break;
case CMD_SERVO_23_CW: modify_bitfield(&directions, 22, CW); break;
case CMD_SERVO_24_ON: modify_bitfield(&states, 23, ON); break;
case CMD_SERVO_24_OFF: modify_bitfield(&states, 23, OFF); break;
case CMD_SERVO_24_CC: modify_bitfield(&directions, 23, CC); break;
case CMD_SERVO_24_CW: modify_bitfield(&directions, 23, CW); break;
...
void move_servos_to_rel_pos(char movement_direction)
{
  ...
  for(char i = 0; i < SERVO_COUNT; i++)
  {
    int temp_pos = STEP * movement_direction;
    ...
    if(temp_states & 0x1) //is last bit one (true)?
    {
      ...
      temp_pos = servos[i].pos + temp_pos; //a sorrend lényeges, mert ha kivonás, akkor a temp_pos-t vonjuk ki!!!
      
      if((temp_pos >= servos[i].min) && (temp_pos <= servos[i].max))
      {
        servos[i].pos = temp_pos;
        Serial.print("Servo number: ");
        Serial.print(i+48);
        Serial.print(" | ");
        Serial.print("Min: ");
        Serial.print(servos[i].min);
        Serial.print(" | ");
        Serial.print("Max: ");
        Serial.print(servos[i].max);
        Serial.print(" | ");
        Serial.print("Position: ");
        Serial.println(servos[i].pos);
        Serial.println("STEP * mov_dir: ");
        Serial.print(STEP * movement_direction);
      }
      if(i<16)
      {
        pwm1.setPWM(i, 0, servos[i].pos);
